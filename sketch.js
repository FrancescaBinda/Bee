...
function setup() {
    ...
    honeysources.forEach(function (honeysource, index) {
        plants.push(new clickableplant(index, honeysource));
    });
...
function drawBeginning() {
    ...
    text("Honeybees", width / 2, height / 3);
    pop();
...
function clickableplant(index, source) {
    this.index = index;
    this.x = source.x;
    this.y = source.y;
    this.w = source.w;
